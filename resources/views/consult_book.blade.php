        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
                <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                    ...
                    <span class="fs-4">Bíblioteca</span>
                </a>
                <ul class="nav nav-pills">
                    <li class="nav-item"><a href="/books/new" class="nav-link" aria-current="page">novo livro</a></li>
                    <li class="nav-item"><a href="/books" class="nav-link active">lista de livros</a></li>
                </ul>
            </header>
        </div>
                ...
                <tbody>
                    @foreach ($books as $book)
                        <tr>
                            ...
                            <td>{{\Carbon\Carbon::parse($book->release_year)->format('d/m/Y')}}</td>
                            <td class="d-flex">
